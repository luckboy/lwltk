...
/// A widget trait.
///
/// The widgets are for example buttons, labels, and text fields. The widget is a GUI component that
/// draws on a window and reacts on events.
pub trait Widget: Container + PreferredSize
{
    ...
    ///
    /// This method doesn't set the referernce-counting pointer to change flag for descendant
    /// widgets.
    ...
    ///
    /// Also, this method sets the referernce-counting pointer to change flag for descendant
    /// widgets.
