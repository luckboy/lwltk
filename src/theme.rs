...
pub trait Theme: Send + Sync
{
    ...
    fn set_fg(&self, cairo_context: &CairoContext, is_enabled: bool, is_focused: bool, is_focused_window: bool) -> Result<(), CairoError>;

    fn set_fg2(&self, cairo_context: &CairoContext, is_enabled: bool, is_focused: bool, is_focused_window: bool) -> Result<(), CairoError>;
    
    fn set_fg3(&self, cairo_context: &CairoContext, is_enabled: bool, is_focused: bool, is_focused_window: bool) -> Result<(), CairoError>;
    
    fn set_fg4(&self, cairo_context: &CairoContext, is_enabled: bool, is_focused: bool, is_focused_window: bool) -> Result<(), CairoError>;

    fn set_fg5(&self, cairo_context: &CairoContext, is_enabled: bool, is_focused: bool, is_focused_window: bool) -> Result<(), CairoError>;
}
